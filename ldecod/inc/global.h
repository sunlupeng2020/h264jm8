...
//对已嵌入的视频流进行解码的标志，在源代码中用此标志，进行控制
//#define EMBEDDED_DEC 1

#define EMBEDDED_DEC_1
...
extern	int EMBEDDEDBITS;//已知嵌入数据的位数
extern	char *embedded_info;//存放解码信息
extern	int decodedbits;//解码了多少位？
#endif
#endif